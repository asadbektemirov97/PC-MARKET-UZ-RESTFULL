...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (ddl.equals("create") && mode.equals("always")){
            ...
            product1.setDescription("Acer nitro 5 intel core i-5 10300f ozu 8gb,ssd 256gb");
            Product product2=new Product();
            product2.setPrice(22000000.0);
            product2.setName("Acer nitro 7");
            product2.setDescription("Acer nitro 7 intel core i-7 10300f ozu 16gb,ssd 512gb");
            ...
            product4.setDescription("Asus TUF gaming intel core i-5 10300f ozu 8gb,ssd 256gb");
            Product product5=new Product();
            product5.setPrice(52000000.0);
            product5.setName("Lenovo legion");
            product5.setDescription("Lenovo Legion gaming  intel core i-7 11300f ozu 32gb,ssd 1tb");
